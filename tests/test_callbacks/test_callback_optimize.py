...
optimization_table_31_1 = [{'section_col': 'WsNoo_Stab_011600_012000', 'reinforcement_col': True, 'reference_year': 2025,
                         'GROUND_IMPROVEMENT': True, 'GROUND_IMPROVEMENT_WITH_STABILITY_SCREEN': True,
                         'GEOTEXTILE': True, 'DIAPHRAGM_WALL': True, 'STABILITY_SCREEN': True},
