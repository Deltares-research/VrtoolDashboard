...
from src.callbacks.database_interaction_page.callback_custom_measure import (
    convert_custom_table_to_input,
    process,
...
class TestCallbackCustomMeasure:
    def test_convert_custom_table_to_input(self):
        row_data = [
            ["measure,dijkvak,mechanism,tijd,Kosten,Betrouwbaarhaid"],
