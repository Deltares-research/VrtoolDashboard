    ...
    "points": [
        {
            ...
            "pointIndex": 39,
            "x": 4.450367300925011,
            "y": 3.5090082684574213,
            "bbox": {
                "x0": 1041.3600000000001,
                "x1": 1049.3600000000001,
                "y0": 685.4300000000001,
                "y1": 693.4300000000001,
            },
    ...
    "points": [
        {
            ...
            "pointNumber": 0,
            "pointIndex": 0,
            "x": 1.5615053647848525,
            "y": 4.113965013046284,
            "customdata": "9 + 45",
            "bbox": {"x0": 871.8, "x1": 879.8, "y0": 509.27, "y1": 517.27},
        }
    ]
}
...
class TestCallbackMeasurePlot:
    ...
    def test_make_graph_measure_results_comparison_callback(self, mechanism):
        ...
        _path_config = (
            Path(__file__).parent.parent / "data/31-1 base coastal case" / "config.json"
        )
        ...
        _vr_config["input_directory"] = (
            Path(__file__).parent.parent / "data/31-1 base coastal case"
        )
    ...
    @pytest.mark.parametrize(
        "click_data", [click_data_measure_point, click_data_optimization_point]
    )
