...
from src.callbacks.comparison_page.callback_tabs_output_switch import make_graph_overview_comparison, \
    make_graph_pf_project_comparison, make_graph_pf_time_comparison, make_map_comparison_measure, \
    update_table_comparison_measures, update_table_comparison_order_measures
...
class TestCallbackComparisonPage:
    ...
    def test_make_graph_pf_project_comparison(self):
        ...
        # 2. Define callback
        def run_callback():
            return make_graph_pf_project_comparison(_imported_runs, 0, ResultType.RELIABILITY.name, 'COST')
    ...
    def test_update_table_comparison_order_measures(self):
        ...
        # 2. Define callback
        def run_callback():
            return update_table_comparison_order_measures(_imported_runs, _table_data, dummy={})
