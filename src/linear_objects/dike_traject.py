...
class DikeTraject(BaseLinearObject):
    ...
    reinforcement_order_forward_vr: Optional[list[str]] = None  # set as Optional with default value to prevent necessary migration for users
    ...
    def serialize(self) -> dict:
        ...
        return {
            ...
            "reinforcement_order_forward_vr": self.reinforcement_order_forward_vr,
    ...
    def deserialize(data: dict) -> "DikeTraject":
        ...
        return DikeTraject(
            ...
            reinforcement_order_forward_vr=data.get("reinforcement_order_forward_vr", None),
