...
from src.layouts.layout_project_page.layout_project_definition_tab import (
    project_definition_tab_layout,
)
from src.layouts.layout_project_page.layout_project_visualization_tab import (
    fill_project_display_overview_table,
    project_visualization_tab_layout,
)
from src.linear_objects.reinforcement_program import DikeProgram, calc_area_stats_new
...
def update_project_page_visualization(
    tabs_switch, result_type: str, imported_runs_data: dict, project_overview_data: list
):
    """
