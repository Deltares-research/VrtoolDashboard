...
from src.layouts.layout_radio_items import (
...
def render_tab_map_content(active_tab: str) -> tuple[html.Div, list, list, list]:
    ...
    disabled_result_type_options = disable_all_radio_options(
        enabled_result_type_options
    )
    ...
    if active_tab == "tab-1":
        return (
            layout_tab_one(),
            disabled_calc_type_options,
            disabled_result_type_options,
            disabled_mechanism_options,
        )
        ...
        return (
            ...
            disabled_calc_type_options,
            enabled_result_type_options,
            enabled_mechanism_options,
        )
    elif active_tab == "tab-3":
        return (
            layout_tab_three(),
            enabled_calc_type_options,
            enabled_result_type_options,
            enabled_mechanism_options,
        )
