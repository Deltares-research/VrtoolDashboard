...
layout_radio_color_bar_result_type = dbc.RadioItems(
    ...
    options=[
        {
            "label": ColorBarResultType.MEASURE.value,
...
layout_radio_result_type = dbc.RadioItems(
    ...
    options=[
        ...
        {
            "label": ResultType.INTERPRETATION_CLASS.value,
            "value": ResultType.INTERPRETATION_CLASS.name,
        },
    ],
...
layout_radio_calc_type = dbc.RadioItems(
    ...
    options=[
        {
            "label": CalcType.DOORSNEDE_EISEN.value,
            "value": CalcType.DOORSNEDE_EISEN.name,
        },
        {
...
layout_radio_greedy_optimization_stop_criteria = dbc.RadioItems(
    ...
    options=[
        {
            "label": GreedyOPtimizationCriteria.ECONOMIC_OPTIMAL.value,
            "value": GreedyOPtimizationCriteria.ECONOMIC_OPTIMAL.name,
        },
        {
            "label": GreedyOPtimizationCriteria.TARGET_PF.value,
            "value": GreedyOPtimizationCriteria.TARGET_PF.name,
        },
    ],
    value=GreedyOPtimizationCriteria.ECONOMIC_OPTIMAL.name,
)
...
layout_radio_result_type_project_page = dbc.RadioItems(
    ...
    options=[
        ...
        {"label": ResultType.PROBABILITY.value, "value": ResultType.PROBABILITY.name},
        {
            "label": ResultType.DISTANCE_TO_NORM.value,
            "value": ResultType.DISTANCE_TO_NORM.name,
        },
