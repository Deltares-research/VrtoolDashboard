    ...
    [
        dbc.NavbarSimple(
            children=[
                ...
                dbc.DropdownMenu(
                    [
                        ...
                        dbc.DropdownMenuItem(
                            "Draaien optimalisatieberekeningen",
                            href="/database-interaction-page",
                        ),
                        dbc.DropdownMenuItem("Gebiedsanalyse", href="/project-page"),
                        dbc.DropdownMenuItem(
                            "Vergelijken berekeningen", href="/comparison-run-page"
                        ),
                    ],
                    nav=True,
                    label="Paginas",
                ...
                dbc.NavLink(
                    "",
                    href="https://deltares-research.github.io/VrtoolDocumentation/",
                    external_link=True,
                    target="_blank",
            ...
            brand=html.Div(
                [
                    html.Img(
                        src="/assets/logo_vrtool.svg", height="40px"
