...
layout_download_overview = html.Div(
    [
        ...
        dbc.Button(
            "Download geojson",
            id=DOWNLOAD_OVERVIEW_BUTTON_ID,
            color="primary",
            className="mr-1",
        ),
...
layout_download_assessment = html.Div(
    [
        ...
        dbc.Button(
            "Download geojson",
            id=DOWNLOAD_ASSESSMENT_BUTTON_ID,
            color="primary",
            className="mr-1",
        ),
...
layout_download_reinforced_sections = html.Div(
    [
        ...
        dbc.Button(
            "Download geojson",
            id=DOWNLOAD_REINFORCED_SECTIONS_BUTTON_ID,
            color="primary",
            className="mr-1",
        ),
        dcc.Download(id=DOWNLOAD_REINFORCED_SECTIONS_ID),
        dcc.Input(
            id=BUTTON_DOWNLOAD_REINFORCED_SECTIONS_NB_CLICKS, value=0, type="hidden"
        ),
    ]
)
...
layout_download_projects = html.Div(
    [
        ...
        dbc.Button(
            "Opslaan projects",
            id=BUTTON_DOWNLOAD_PROJECTS_EXPORT,
            color="primary",
            className="mr-1",
        ),
