...
from src.layouts.layout_comparison_page.layout_table_comparison import (
    table_ag_grid_comparison_measures,
)
from src.layouts.layout_comparison_page.layout_table_comparison_order_section import (
    ...
    return html.Div(
        children=[
            ...
            html.Div(
                ...
                children=[
                    dcc.Graph(
                        id=RUNS_COMPARISON_GRAPH_TIME_ID,
                        figure=plot_default_scatter_dummy(),
                        style={"width": "100%", "height": "100%"},
                    ),
                ],
