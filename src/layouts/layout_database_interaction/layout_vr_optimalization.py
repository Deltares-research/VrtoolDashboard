...
dike_vr_optimization_layout_ag_grid = html.Div(
    [
        ...
        html.Div(
            [
                dbc.Input(
                    id=NAME_NEW_OPTIMIZATION_RUN_ID,
                    placeholder="Naam berekening",
                    type="text",
                ),
                dbc.Button(
                    "Start optimalisatieberekening",
                    id=OPTIMIZE_BUTTON_ID,
                    color="primary",
                    className="mr-1",
                ),
                dbc.Tooltip(
                    "Klik hier om de berekening met de geselecteerde maatregelen te starten.",
