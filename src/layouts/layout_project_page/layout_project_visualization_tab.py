...
from src.component_ids import (
    ...
    PROJECT_OVERVIEW_TABLE_DISPLAY,
    PROJECT_PAGE_VISUALIZATION_COST_GRAPH,
    PROJECT_PAGE_VISUALIZATION_RELIABILITY_GRAPH,
    TOTAL_AREA_COST,
    TOTAL_AREA_RISK_TABLE,
)
...
def fill_project_display_overview_table(projects: list[DikeProject]):
    elements_updated = [
        {
            ...
            "project_reliability_before_reinforcement": "{:.2e}".format(
                project.project_failure_prob_assessement
            ),
            "project_reliability_after_reinforcement": "{:.2e}".format(
                project.project_failure_prob_after_reinforcement
            ),
        }
    ...
    return [
        dmc.Table(
            children=[head, body_updated, caption],
            ...
            html.Div(
                ...
                children=[
                        ...
                        children=[
                            dmc.SimpleGrid(
                                ...
                                children=[
                                    html.P(""),
                                    dmc.Text(
                                        "Totale versterkingskosten:", td="underline"
                                    ),
                    ...
                    html.Div(
                        ...
                        style={
                            "height": "300px"
                        },  # Set container height to ensure the grid is displayed
                    ),
                ],
            ),
        ],
...
cost_chart = dcc.Graph(
    id=PROJECT_PAGE_VISUALIZATION_COST_GRAPH,
    figure=plot_default_scatter_dummy(),
    style={"width": "100%", "height": "100%"},
)

reliability_chart_box = html.Div(
    children=[
        layout_radio_result_type_project_page,
        dcc.Graph(
            id=PROJECT_PAGE_VISUALIZATION_RELIABILITY_GRAPH,
            figure=plot_default_scatter_dummy(),
...
table = html.Div(
    id=PROJECT_OVERVIEW_TABLE_DISPLAY, children=[dmc.Table([head, body, caption])]
)
