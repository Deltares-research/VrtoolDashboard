...
from src.layouts.layout_database_interaction.layout_modal_add_custom_measure import (
    modal_custom_measure,
)
from src.layouts.layout_traject_page.layout_modal_measure import (
...
_dash_renderer._set_react_version(
    "18.2.0"
)  # keep this line to avoid error with MantineProvider
...
app.layout = dmc.MantineProvider(
    dbc.Container(
        ...
        children=[
            ...
            dcc.Store(
                id=STORED_PROJECT_OVERVIEW_DATA, data=None, storage_type="session"
            ),
            nav_bar_layout_1,
