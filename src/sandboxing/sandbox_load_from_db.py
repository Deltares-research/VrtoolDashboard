...
_vr_config = VrtoolConfig().from_json(
    Path(
        ...
        r"c:\Users\hauth\OneDrive - Stichting Deltares\Documents\tempo\VRM\debug_nov2025\config.json"
...
t0 = time.time()
_traject_db = get_dike_traject_from_config_ORM(
    vr_config=_vr_config, run_is_vr=1, run_id_dsn=2
)
