...
_fig = plot_pf_length_cost(_traject_db, 2025, result_type=ResultType.RELIABILITY.name, cost_length_switch="COST", greedy_criteria="TARGET_PF", greedy_criteria_params=(3.5, 2050))
t2 = time.time()
